...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ImageScene_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 30, 6)
    ...
    "ImageScene\0mouseMoved\0\0oldPos\0newPos\0"
};
...
void ImageScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->mouseMoved((*reinterpret_cast< QPointF(*)>(_a[1])),(*reinterpret_cast< QPointF(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (ImageScene::*_t)(QPointF , QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageScene::mouseMoved)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ImageScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_ImageScene.data,
      qt_meta_data_ImageScene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ImageScene.stringdata))
...
// SIGNAL 0
void ImageScene::mouseMoved(QPointF _t1, QPointF _t2)
{
